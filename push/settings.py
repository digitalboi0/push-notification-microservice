...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'push_notifications'),
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.path.join(LOGS_DIR, 'push_notifications.log'),
...
CACHES = {
    'default': {
        ...
        'LOCATION': 'unique-snowflake', # Optional, but recommended if you have multiple caches
    }
}
